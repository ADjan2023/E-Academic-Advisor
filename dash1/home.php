...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="home.php">
                    <img src="images/logo.png" width="200px" alt="Ashesi E-Academic Advisor" />
                </a>
            </div>
                     ...
                     <!--    </li>
                        ...
                        <li>
                            <a href="electives.php">
                                <i class="far fa-check-square"></i>View Electives</a>
                        </li>
                         <li>
                            <a href="form.php">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">overview of Courses Completed</h2>
                                ...
                                <div class="overview-item overview-item--c1">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            <div class="icon">
                                                 <img src="images/elect.png" width='50px' alt="Cool Admin" />
                                            </div>
                                            <div class="text">
                                                <h2><?php
        ob_start();
                                ...
                                <div class="overview-item overview-item--c1">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <h2>1</h2>
                                                <span>Non-Major Course(s) Taken</span>
                                            </div>
                                        </div>
                                        <div class="overview-chart">
                                            <canvas id="widgetChart1"></canvas>
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="overview-item overview-item--c4">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            <div class="icon">
                                               <img src="images/check.png" width='50px' alt="Cool Admin" />
                                            </div>
                                            <div class="text">
                                                <h2><?php
        ob_start();
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <strong class="card-title" v-if="headerText">INTEREST TAGS</strong>
                                    </div>
                                    <div class="card-body">
